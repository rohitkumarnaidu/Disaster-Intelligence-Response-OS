...
`);
  ...
  write('01-overview/product-overview.md', `---
id: product-overview
...
`);
  ...
  write('01-overview/core-concepts.md', `---
id: core-concepts
title: Core Concepts
sidebar_position: 3
---
...
`);
  ...
  write('01-overview/terminology.md', `---
id: terminology
title: Terminology
sidebar_position: 4
---
...
`);
  ...
  write('02-getting-started/prerequisites.md', `---
id: prerequisites
title: Prerequisites
sidebar_position: 1
---
...
`);
  ...
  write('02-getting-started/installation.md', `---
id: installation
title: Installation
sidebar_position: 2
---
...
`);
  ...
  write('02-getting-started/local-development.md', `---
...
`);
  ...
  write('02-getting-started/environment-variables.md', `---
...
`);
  ...
  write('02-getting-started/first-run.md', `---
id: first-run
